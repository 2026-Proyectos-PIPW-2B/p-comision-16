...
function productosPorDefecto() {
  ...
  const nombreProductos = [
    ...
    "Impresora Portátil Epson WorkForce WF-100",
    "Globos con Helio",
    "Destornillador Plano 8x200 Mm Stanley",
  ...
  const imagenes = [
    "img/7155-AFmP9L._SY500_.jpg",
    "img/blackberry-bold-touch-9900-4541-g-alt.jpg",
    "img/WF-100_C11CE05302_3.jpg",
    "img/Globos-Helio.png",
  ...
  const stock = [100, 5, 2, 20, 15, 8, 35, 40, 3];

  for (const i in nombreProductos) {
    const producto = crearProducto(nombreProductos[i], imagenes[i], precios[i], stock[i]);
